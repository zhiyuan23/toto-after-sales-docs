...
进度文档组按 4 个功能端、26 个功能模块和 96 个入口组展示：总览负责项目级汇总，4 份功能端明细负责逐入口状态。总览同时增加“独立售后子系统实施进度”，展示已落到真实代码并完成当前切片验证的成果；它与 96 个入口的最终业务验收口径并列，不混算。统一管理后台与代理商工作台共用 `gaia-ui` 的“售后服务”顶部菜单，因此 4 个功能端实际落在 3 类应用载体中。需求目录保留 119 个功能编号及开发任务依赖；C16“客服热线”已归入 CAPP-009，尚有 C17“了解更多咨询”的详细需求待补编号。菜单定义和需求索引不维护状态，当前状态统一从开发进度总览进入。
