...
更新日期：2026-09-14（仅更新两个小程序的本地仓库状态；其他现场记录保留原时点）
...
flowchart LR
  ...
  SERVICE["客服人员"] -.应用待实现.-> CSMINI["gaia-customer-service-uni"]
...
| `gaia-after-sales-uni` | `Gaia/mobile/gaia-after-sales-uni` | 原 TOTO 售后小程序与 H5 | 保持独立，仅使用本地 Git，未配置远程，不承载新客服助手 |
| `gaia-customer-service-uni` | `Gaia/mobile/gaia-customer-service-uni` | “TOTO客服助手” | 2026-09-14 已初始化独立本地 Git，仅有说明文件，无远程；身份、页面、登录、权限和技术基线待确认 |
