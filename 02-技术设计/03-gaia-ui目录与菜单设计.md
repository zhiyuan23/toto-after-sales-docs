...
当前导航以[后台菜单与角色权限手册](09-后台菜单与岗位权限矩阵.md)为准。程序已接入四个工作视角、16 个展示分组（2026-09-12 源码快照）、管理员全局切换、授权菜单投影、默认首页与直达校验；原有 10 个业务域仅保留为唯一注册和代码存储结构。总部视角将配件档案放在“商品资料”的配套品档案之后，“配件管理”从库存台账开始；服务站没有商品资料分组，仍将配件档案放在“配件管理”首位。V3 实施范围及验证边界见[后台菜单与工作视角收敛记录](../specs/2026-09-11-后台菜单与工作视角收敛.md)。
...
9. 展示顺序由工作视角清单维护，遵循高频任务优先、查询早于资料维护、维度先于主体、单据按业务发生顺序。总部“商品资料”按商品分类、商品系列、商品档案、配套品档案、配件档案排列，“配件管理”从库存台账开始；服务站“配件管理”仍按配件档案、库存台账及业务单据排列。同一功能可在不同视角投影到适合该岗位的分组，但保持唯一 code、path 和页面。
