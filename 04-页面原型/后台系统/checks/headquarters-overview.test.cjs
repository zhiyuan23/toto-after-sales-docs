...
test('四视角入口和总部两个工作台版本命名完整',()=>{for(const file of ['headquarters-map.html','customer-service-v03.html','service-station-v02.html','dealer.html'])assert.match(html,new RegExp(`href="${file}"`));assert.match(html,/href="#headquarters"/);assert.match(html,/运营工作台/);assert.doesNotMatch(html,/运营概览/);assert.match(html,/5 \/ 5/)})
