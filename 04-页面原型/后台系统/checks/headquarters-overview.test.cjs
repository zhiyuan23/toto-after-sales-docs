...
test('四视角入口和总部入口完整',()=>{for(const file of ['customer-service.html','service-station.html','dealer.html'])assert.match(html,new RegExp(`href="${file}"`));assert.match(html,/href="#headquarters"/);assert.match(html,/4 \/ 4/)})
