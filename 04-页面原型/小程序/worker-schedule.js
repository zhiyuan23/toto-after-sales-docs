...
(function () {
  ...
  function act(action,value){switch(action){
    ...
    case 'date-route':if(state.date<TODAY)throw Error('过去日期只回看任务，请先确认新的预约');window.TOTO_WORKER_MAP.openDate(state.date,true);return 'w-map';
  }return null;}
