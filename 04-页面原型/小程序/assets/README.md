...
2026-09-12 从项目已有官网素材清单中选取并下载原图，保留原图内容和比例，用于消费者产品中心的构图评审。产品外观来自官网；购买记录、客户资料、房间名称、安装码与服务单均为原型虚构数据，不代表真实购买或关联关系。
...
项目已有核对依据：[官方素材清单](../../../specs/evidence/2026-09-11-toto-online-showcase/manifest.json)。两张 JPEG 均为 630 × 500，原型使用等比完整展示。
